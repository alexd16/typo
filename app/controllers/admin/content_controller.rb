...
class Admin::ContentController < Admin::BaseController
  ...
  def merge_articles
    ...
    begin
      ...
      flash[:notice] = "Articles merged with success"
    rescue Article::SameArticleError
      flash[:error] = "The articles to merge can't be the same"
    rescue Article::ArticleDoesNotExistError
      flash[:error] = "The target article does not exist"
    end
    redirect_to '/'
  end
